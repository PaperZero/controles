...
namespace controle.DAL
{
    public class ProdutoDAL
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("set dateformat dmy insert into produto values(@Nome_Produto, @Preco, @Quantidade, @Validade)", conn);
        ...
        public ProdutoDAL pesquisarID(ProdutoDAL pesquisarID)
        {
            ...
            if (dr.Read())
            {
                ...
                objfoi.Validade = Convert.ToDateTime(dr["Validade"]);
        ...
        public List<ProdutoDAL> Pesquisar()
        {
            ...
            while (dr.Read())
            {
                ...
                objlista.Validade = Convert.ToDateTime(dr["Validade"]);
        ...
        public void tudo(ProdutoDAL tudo)
        {
